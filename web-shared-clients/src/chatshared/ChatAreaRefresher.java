...
//        this.httpRequestLoggerConsumer = httpRequestLoggerConsumer;
    ...
    public void run() {
        ...
        String finalUrl = HttpUrl
                .parse(ConstantsAll.CHAT_LINES_LIST)
                .newBuilder()
//                .addQueryParameter("chatversion", String.valueOf(chatVersion.get()))
                .addQueryParameter(ConstantsAll.QP_CHAT_VERSION, String.valueOf(chatVersion.get()))
                .build()
                .toString();
...
//                    httpRequestLoggerConsumer.accept("Response of Chat Request # " + finalRequestNumber + ": " + rawBody);
                    ChatLinesWithVersion chatLinesWithVersion = ConstantsAll.GSON_INSTANCE.fromJson(rawBody, ChatLinesWithVersion.class);
