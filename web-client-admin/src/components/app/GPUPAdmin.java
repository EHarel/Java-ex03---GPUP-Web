...
public class GPUPAdmin extends javafx.application.Application {
    private static Stage mainStage;

    @Override
    public void start(Stage primaryStage) throws Exception {
        GPUPAdmin.mainStage = primaryStage;
...
//        Scene scene = new Scene(mainComponent, 600, 600);
    ...
    private void loadLogin(AppMainController mainController) {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader();
            URL url = getClass().getResource("/components/login/LoginAdmin.fxml");
            fxmlLoader.setLocation(url);
