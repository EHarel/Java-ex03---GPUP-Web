...
import components.app.GPUPApplication;
...
public class CompilationConfigurationController {
    ...
    void chooseFolderOutputButtonActionListener(ActionEvent event) {
        ...
        File selectedFile = directoryChooser.showDialog(GPUPApplication.getStage());
    ...
    public void loadConfig(String configName) {
        ConfigurationDTOCompilation configData = (ConfigurationDTOCompilation) Engine.getInstance().getConfigSpecific(TaskType.COMPILATION, configName);
